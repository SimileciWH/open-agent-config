...
fn parse_dt(s: String) -> chrono::DateTime<chrono::Utc> {
    chrono::DateTime::parse_from_rfc3339(&s)
        ...
        .unwrap_or_else(|e| {
            eprintln!("[oac] parse_dt: invalid RFC3339 {:?}: {}", s, e);
            chrono::Utc::now()
        })
}
...
impl Store {
    pub fn open(path: &Path) -> Result<Self, OacError> {
        ...
        if version > LATEST_SCHEMA_VERSION {
            eprintln!(
                "[open-agent-config] Warning: database schema v{} is newer than this binary supports (v{})",
    ...
    fn migrate_add_column(&self, sql: &str) {
        if let Err(e) = self.conn.execute(sql, []) {
            ...
            if !msg.contains("duplicate column") {
                eprintln!("[open-agent-config] Migration warning: {} — {}", sql, msg);
            }
        }
    }
    ...
    fn backup_before_migrate(&self, current_version: i64) {
        ...
        {
            eprintln!(
                "[open-agent-config] Warning: failed to back up database before migration: {}",
                e,
            );
        }
    }

    fn migrate(&self) -> Result<(), OacError> {
    ...
    fn migrate_v1(&self) -> Result<(), OacError> {
        self.conn.execute_batch(
            "
    ...
    fn migrate_v3(&self) -> Result<(), OacError> {
    ...
    fn migrate_v4(&self) -> Result<(), OacError> {
    ...
    fn migrate_v5(&self) -> Result<(), OacError> {
        self.conn.execute_batch(
            "
    ...
    fn migrate_v7(&self) -> Result<(), OacError> {
        self.conn.execute_batch(
    ...
    fn migrate_v8(&self) -> Result<(), OacError> {
        self.conn.execute_batch(
    ...
    fn migrate_v9(&self) -> Result<(), OacError> {
    ...
    fn migrate_v6(&self) -> Result<(), OacError> {
    ...
    fn migrate_v2(&self) -> Result<(), OacError> {
        self.conn.execute_batch("
    ...
    pub fn schema_version(&self) -> Result<i64, OacError> {
        self.conn
            .query_row(
                "SELECT version FROM schema_version WHERE rowid = 1",
                [],
    ...
    pub fn get_agent_setting(&self, name: &str) -> Result<(Option<String>, bool), OacError> {
        let mut stmt = self
            .conn
    ...
    pub fn set_agent_path(&self, name: &str, path: Option<&str>) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn set_agent_enabled(&self, name: &str, enabled: bool) -> Result<(), OacError> {
        self.conn.execute(
            "INSERT INTO agent_settings (name, custom_path, enabled)
             VALUES (?1, NULL, ?2)
    ...
    pub fn get_agent_order(&self) -> Result<Vec<(String, i32)>, OacError> {
        ...
        let rows: Vec<(String, i32)> = stmt
            ...
            .filter_map(|r| r.map_err(|e| eprintln!("[oac] row error: {e}")).ok())
            .collect();
        Ok(rows)
    }

    /// Persist a custom agent order. `names` is the full ordered list of agent names.
    pub fn set_agent_order(&self, names: &[String]) -> Result<(), OacError> {
    ...
    pub fn remove_custom_config_path(&self, id: i64) -> Result<(), OacError> {
        self.conn
    ...
    pub fn list_custom_config_paths(
        &self,
        agent: &str,
    ) -> Result<Vec<CustomConfigPathRow>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn list_all_custom_config_paths(&self) -> Result<Vec<String>, OacError> {
    ...
    pub fn insert_extension(&self, ext: &Extension) -> Result<(), OacError> {
    ...
    pub fn get_extension(&self, id: &str) -> Result<Option<Extension>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn set_enabled(&self, id: &str, enabled: bool) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn get_disabled_config(&self, id: &str) -> Result<Option<String>, OacError> {
        let mut stmt = self
            .conn
    ...
    pub fn set_disabled_config(&self, id: &str, config: Option<&str>) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn set_install_meta(&self, id: &str, meta: &InstallMeta) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn clear_install_meta(&self, id: &str) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn update_trust_score(&self, id: &str, score: u8) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn update_tags(&self, id: &str, tags: &[String]) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn batch_update_tags(&self, ids: &[String], tags: &[String]) -> Result<(), OacError> {
    ...
    pub fn get_all_tags(&self) -> Result<Vec<String>, OacError> {
        let mut stmt = self
            .conn
    ...
    pub fn update_pack(&self, id: &str, pack: Option<&str>) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn batch_update_pack(&self, ids: &[String], pack: Option<&str>) -> Result<(), OacError> {
        let tx = self.conn.unchecked_transaction()?;
        for id in ids {
            tx.execute(
                "UPDATE extensions SET pack = ?1 WHERE id = ?2",
    ...
    pub fn get_all_packs(&self) -> Result<Vec<String>, OacError> {
        let mut stmt = self
            .conn
    ...
    pub fn find_ids_by_pack(&self, pack: &str) -> Result<Vec<String>, OacError> {
        let mut stmt = self
            .conn
    ...
    pub fn find_ids_by_name_and_kind(&self, name: &str, kind: &str) -> Result<Vec<String>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn find_siblings_by_source_path(&self, id: &str) -> Result<Vec<String>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn get_child_skills(&self, cli_id: &str) -> Result<Vec<Extension>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn link_skills_to_cli(&self, cli_id: &str, skill_ids: &[String]) -> Result<(), OacError> {
    ...
    pub fn unlink_cli_children(&self, cli_id: &str) -> Result<(), OacError> {
        self.conn.execute(
    ...
    fn sync_extension_agents(conn: &rusqlite::Connection, ext_id: &str, agents: &[String]) -> Result<(), OacError> {
    ...
    pub fn delete_extension(&self, id: &str) -> Result<(), OacError> {
    ...
    pub fn sync_extensions(&self, extensions: &[Extension]) -> Result<(), OacError> {
        // unchecked_transaction: safe because Store is behind a Mutex (single-writer guaranteed)
        let tx = self.conn.unchecked_transaction()?;
        ...
        // - Skills that existed before OAC was installed (user git-cloned them)
    ...
    fn refresh_stale_git_install_meta(conn: &rusqlite::Connection) -> Result<(), OacError> {
        let mut stmt = conn.prepare(
            "SELECT id, install_url, json_extract(source_json, '$.url'),
             ...
             WHERE install_type = 'git'
               ...
               -- record. A `.git`-inferred source (e.g. an OAC-git-installed
    ...
    fn backfill_packs(conn: &rusqlite::Connection) -> Result<(), OacError> {
    ...
    pub fn run_backfill_packs(&self) -> Result<(), OacError> {
        Self::backfill_packs(&self.conn)
    }

    pub fn insert_audit_result(&self, result: &AuditResult) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn get_audit_results(&self, extension_id: &str) -> Result<Vec<AuditResult>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn list_latest_audit_results(&self) -> Result<Vec<AuditResult>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn count_latest_findings_by_severity(&self) -> Result<std::collections::HashMap<String, usize>, OacError> {
    ...
    pub fn insert_project(&self, project: &Project) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn delete_project(&self, id: &str) -> Result<(), OacError> {
    ...
    pub fn list_projects(&self) -> Result<Vec<Project>, OacError> {
        let mut stmt = self
            .conn
    ...
    fn row_to_extension(&self, row: &rusqlite::Row) -> Result<Extension, OacError> {
        ...
        Ok(Extension {
            ...
            kind: kind_str
                .parse()
                .map_err(|e: anyhow::Error| OacError::Internal(e.to_string()))?,
            name: row.get(2)?,
            ...
            installed_at: DateTime::parse_from_rfc3339(&installed_at_str)
                .map_err(|e| OacError::Internal(format!("Invalid installed_at timestamp: {e}")))?
                .with_timezone(&Utc),
            updated_at: DateTime::parse_from_rfc3339(&updated_at_str)
                .map_err(|e| OacError::Internal(format!("Invalid updated_at timestamp: {e}")))?
                .with_timezone(&Utc),
    ...
    pub fn insert_kit(&self, row: &KitRow) -> Result<(), OacError> {
        self.conn.execute(
    ...
    pub fn update_kit_zip_path(&self, id: &str, zip_path: &str) -> Result<(), OacError> {
        self.conn.execute(
            "UPDATE kits SET zip_path = ?2 WHERE id = ?1",
            params![id, zip_path],
        )?;
        Ok(())
    }

    pub fn delete_kit(&self, id: &str) -> Result<(), OacError> {
        self.conn.execute("DELETE FROM kits WHERE id = ?1", params![id])?;
        Ok(())
    }

    pub fn list_kit_rows(&self) -> Result<Vec<KitRow>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn get_kit_row(&self, id: &str) -> Result<Option<KitRow>, OacError> {
        let r = self
            .conn
            .query_row(
                "SELECT id, name, description, zip_path, created_at, updated_at
    ...
    pub fn list_kit_assets(&self, kit_id: &str) -> Result<Vec<KitAssetRow>, OacError> {
        let mut stmt = self.conn.prepare(
    ...
    pub fn list_kit_config_files(&self, kit_id: &str) -> Result<Vec<KitConfigFileRow>, OacError> {
        let mut stmt = self.conn.prepare(
            "SELECT kit_id, agent, category, source_path, source_file_name, position
        ...
        let rows = stmt.query_map(params![kit_id], |row| {
            ...
            let category = cat_s.parse::<ConfigCategory>().unwrap_or_else(|_| {
                eprintln!(
                    "[oac] list_kit_config_files: unknown ConfigCategory {:?}, falling back to Settings",
                    cat_s
                );
    ...
    pub fn upsert_sync_record(&self, row: &SyncRecordRow) -> Result<(), OacError> {
        let paths_json = serde_json::to_string(&row.written_paths)
            .map_err(|e| OacError::Internal(format!("written_paths serialize: {e}")))?;
        self.conn.execute(
    ...
    pub fn get_sync_record(
        ...
        project_path: &str,
        agent_name: &str,
    ) -> Result<Option<SyncRecordRow>, OacError> {
        let row = self
            .conn
            .query_row(
    ...
    pub fn list_sync_records_for_kit(&self, kit_id: &str) -> Result<Vec<SyncRecordRow>, OacError> {
        let mut stmt = self.conn.prepare(
            "SELECT id, kit_id, project_path, agent_name, written_paths, synced_at
    ...
    pub fn list_all_sync_records(&self) -> Result<Vec<SyncRecordRow>, OacError> {
        let mut stmt = self.conn.prepare(
            "SELECT id, kit_id, project_path, agent_name, written_paths, synced_at
               FROM kit_sync_records
              ORDER BY synced_at DESC",
...
mod tests {
    ...
    fn test_refresh_preserves_authoritative_install_url_for_inferred_source() {
        // Regression: an OAC-git-installed skill records the real upstream in
        // install_meta. If the user keeps ~/.claude under a dotfiles git repo,
        // the scanner (no .skill-lock.json entry for an OAC install) infers the
        ...
        store
            ...
            .unwrap();
        store.update_pack("oac-skill", Some("real/my-skill")).unwrap();

        let mut scanned = skill.clone();
        scanned.install_meta = None;
        store.sync_extensions(&[scanned]).unwrap();

        let got = store.get_extension("oac-skill").unwrap().unwrap();
    ...
    fn test_stale_row_should_prune_decision() {
        ...
        let missing = "/nonexistent/open-agent-config/ghost/SKILL.md";
    ...
    fn test_sync_prunes_ghost_skill_with_install_meta_when_files_deleted() {
        ...
        ghost.source_path = Some("/nonexistent/open-agent-config/ghost/SKILL.md".into());
        ...
        cli.kind = ExtensionKind::Cli;
        cli.source_path = Some("/nonexistent/open-agent-config/cli-bin".into());
    ...
    fn test_sync_backfills_install_meta_from_git_source() {
        ...
        // (simulates a skill that existed before OAC was installed)
        let mut ext = sample_extension();
