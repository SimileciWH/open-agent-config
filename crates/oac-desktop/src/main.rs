...
fn main() {
    let store = app_paths::open_store().expect("Failed to open OAC database");
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::count_project_extensions,
            ...
            commands::export_kit,
            commands::import_kit,
            commands::list_project_install_records,
            icon::set_app_icon,
        ])
